...
\node[statebox, anchor=north west] (EPS) at (0.1, -5.9) {
  ...
  \texttt{goals}: list[GoalForBrain] \quad 只读投影\\[1mm]
...
\node[nodebox] (think) at (13.8, -8.0) {think\\[-1pt]{\scriptsize choose()\\$\rightarrow$ActionFromBrain}};
